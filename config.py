...
# Конфигурация визуального мастера инбаундов
ENABLE_INBOUND_WIZARD = config("ENABLE_INBOUND_WIZARD", default=True, cast=bool)
INBOUND_TEMPLATES_DIRECTORY = config("INBOUND_TEMPLATES_DIRECTORY", default="templates")
