...
import importlib
transport_dot_global_dot_config__pb2 = importlib.import_module('wildosnode.backends.xray.api.proto.transport.global.config_pb2')
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_CONFIG'].fields_by_name['transport']._loaded_options = None
