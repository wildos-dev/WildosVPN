...
```shell
mkdir /var/lib/wildosvpn/templates/sing-box
```
...
```
Now, restart your WildosVPN and enjoy.

If you have already changed your env variables, and you want to just update the template files, there is no need to restart WildosVPN.
